...
import { Alert, Button, FlatList, ImageBackground, Platform, StyleSheet, Text, TouchableOpacity, View } from 'react-native'
        ...
        <View style={styles.container}>
            <ImageBackground
                ...
                <View style={styles.iconBar}>
                    <TouchableOpacity onPress={() => props.navigation.navigate ( 'routesDrawer' ) }>
                        <Icon name='bars'
                            size={30} color='black' />
                    </TouchableOpacity>
            ...
            <View style={styles.rodape}>
                ...
                >
                    <Avatar
                        ...
                        source={{
                            uri:
                                'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQin1hoLOew8Fj3PFebuiPNGWI2q2ekEXmL48KLzDHVU0nal9G3',
                        }}
                ...
                >
                    <Avatar
                        ...
                        source={{
                            uri:
                                'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcS5ul7coSk35DXrFWtgfWZTKDXkwkZHk5RbuFvQZwjQuGFU9-C9',
                        }}
                ...
                ><Badge value="3+" status="error"
                    containerStyle={{ position: 'absolute', top: -3, right: 13 }} />
                    <Avatar

                        size="medium"
                        source={{
                            uri:
                                'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTMCVi3G42JXdvrCC9sbKrKcw8aKrBY3lHG2vKss4FLDUHuf7l_',
                        }}
                        onPress={() => console.log("Works!")}
                        activeOpacity={0.7}
                    />
