...
const itemEstilo = {
    ...
    alignItems: 'center',  //alignItems: 'flex-end',// alinhar no fi da linha
    flexDirection: 'row', // aqui eu difino qual sera o eixo maim axis e nao o cross axis relacionado as demais configuracao do componente
    justifyContent: 'space-between', // : 'flex-strat' //no inicio da celula
//     justifyContent: 'space-around', 
